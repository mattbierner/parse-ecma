...
define(["require", "exports", "bennu/parse", "bennu/lang", "bennu/text", "nu-stream/stream", "./line_terminator_lexer",
    ...
    (singleStringLiteral = parse.label("Single String Literal", parse_lang.between(singleQuote, singleQuote,
    ...
    (doubleStringLiteral = parse.label("Double String Literal", parse_lang.between(doubleQuote, doubleQuote,
