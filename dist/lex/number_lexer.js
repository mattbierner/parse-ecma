...
define(["require", "exports", "bennu/parse", "bennu/lang", "bennu/text", "nu-stream/stream"], (function(require,
    ...
    var p;
    (decimalDigits = parse.label("Decimal Digits Lexer", ((p = parse.many1(decimalDigit)), parse.bind(p, (
        function(s) {
    ...
    (signedInteger = parse.label("Signed Integer Lexer", parse.either(parse.next(negativeSign, parse.bind(
        unsignedInteger, (function(num) {
            return parse.always((-num));
        }))), parse.next(parse.optional(positiveSign), unsignedInteger))));
    ...
    (hexIntegerLiteral = parse.label("Hex Integer Literal Lexer", parse.next(hexIndicator, parse.expected(
    ...
    (numericLiteral = parse.label("Numeric Literal Lexer", parse.either(parse.next(parse.attempt(hexIndicator),
