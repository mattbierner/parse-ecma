...
define(["require", "exports", "bennu/parse", "bennu/lang", "nu-stream/stream", "ecma-ast/declaration",
    ...
    "use strict";
    var functionBody, functionExpression, functionDeclaration, sourceElement, sourceElements, program,
    ...
    (functionExpression = parse.Parser("Function Expression", ecma_parse.nodea(parse.next(token.keyword(
            "function"), parse.enumeration(parse.optional(null, value.identifier), parse_lang.between(
        ...
        .create)));
    (functionDeclaration = parse.Parser("Function Declaration", ecma_parse.nodea(parse.next(token.keyword(
