...
define(["require", "exports", "bennu/parse", "bennu/lang", "ecma-ast/clause", "ecma-ast/declaration",
    ...
    (variableStatement = parse.label("Variable Statement", ecma_parse.node(parse_lang.between(token.keyword(
    ...
    (ifStatement = parse.label("If Statement", ecma_parse.nodea(parse.next(token.keyword("if"), parse.enumeration(
            parse_lang.between(punctuator("("), punctuator(")"), parse.expected("if test",
                ...
                parse.next(token.keyword("else"), parse.expected("if alternate", statement))))),
    ...
    (whileStatement = parse.label("While Statement", ecma_parse.nodea(parse.next(token.keyword("while"), parse.enumeration(
        ...
        .create)));
    (doWhileStatement = parse.label("Do While Statement", ecma_parse.nodea(parse.next(token.keyword("do"),
            parse.enumeration(parse.expected("do-while body", statement), parse.next(token.keyword(
                "while"), parse_lang.between(punctuator("("), punctuator(")"), parse.expected(
                "do-while test", expression.expression))), punctuator(";"))), ast_statement.DoWhileStatement
        .create)));
    ...
    (forStatement = parse.label("For Statement", ecma_parse.nodea(parse.next(token.keyword("for"), parse.next(
    ...
    (forInStatement = parse.label("For In Statement", ecma_parse.nodea(parse.next(token.keyword("for"), parse.next(
            punctuator("("), parse.enumeration(parse_lang.then(forInLeft, token.keyword("in")),
    ...
    (continueStatement = parse.label("Continue Statement", ecma_parse.node(parse_lang.between(token.keyword(
    ...
    (breakStatement = parse.label("Break Statement", ecma_parse.node(parse_lang.between(token.keyword("break"),
        ...
        .create)));
    (returnStatement = parse.label("Return Statement", ecma_parse.node(parse_lang.between(token.keyword(
            "return"), logicalSemiColon, parse.optional(noLineTerminator(expression.expression))),
    ...
    var caseClause = ecma_parse.nodea(parse.next(token.keyword("case"), parse.enumeration(parse_lang.then(parse
            .expected("case test", expression.expression), punctuator(":")), statementList)), ast_clause.SwitchCase
        .create),
        defaultClause = ecma_parse.node(parse.next(token.keyword("default"), parse.next(punctuator(":"),
    ...
    (switchStatement = parse.label("Switch Statement", ecma_parse.nodea(parse.next(token.keyword("switch"),
        parse.enumeration(parse_lang.between(punctuator("("), punctuator(")"), expression.expression),
    ...
    (tryStatement = parse.label("Try Statement", ecma_parse.nodea(parse.next(token.keyword("try"), parse.enumeration(
    ...
    (debuggerStatement = parse.label("Debugger Statement", ecma_parse.node(parse.next(token.keyword("debugger"),
