 ...
 */
var hexEscapeSequence = parse.next(parse_text.character('x'),
 ...
 */
var unicodeEscapeSequence = parse.next(parse_text.character('u'),
...
var escapeSequence = parse.choice(
    ...
    parse.next(parse_text.character('0'), parse.next(parse.either(
        parse.eof,
