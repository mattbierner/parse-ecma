 ...
 */
define(['parse/parse', 'parse/parse_string', 'parse/parse_lang',
        'nu/stream',
...
// Constants
////////////////////////////////////////
var doubleQuote = parse_string.character('"');
var escape = parse_string.character('\\');
var singleQuote = parse_string.character("'");
...
var singleEscapeCharacter = parse.choice(
    ...
    parse_string.character('"'),
    parse_string.character('\\'),
    parse.next(parse_string.character('b'), parse.always('\u0008')),
    parse.next(parse_string.character('f'), parse.always('\u000C')),
    parse.next(parse_string.character('n'), parse.always('\u000A')),
    parse.next(parse_string.character('r'), parse.always('\u000D')),
    parse.next(parse_string.character('t'), parse.always('\u0009')),
    parse.next(parse_string.character('v'), parse.always('\u000B')));
...
var escapeCharacter = parse.choice(
    ...
    parse_string.character('u'),
    parse_string.character('x'));
 ...
 */
var hexEscapeSequence = parse.next(parse_string.character('x'),
 ...
 */
var unicodeEscapeSequence = parse.next(parse_string.character('u'),
...
var escapeSequence = parse.choice(
    ...
    parse.next(parse_string.character('0'), parse.next(parse.either(
        parse.eof(),
