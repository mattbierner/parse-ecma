...
var extend = function(obj, props) {
    return Object.defineProperties(
        Object.getOwnPropertyNames(obj).reduce(function(p, key) {
 ...
 * Primary Expression
 */
var primaryExpression = parse.memo(parse.Parser('Primary Expression',
    parse.choice(
        functionExpression,
        thisExpression,
        value.identifier,
...
var memberExpression = (function(){
    ...
    return parse.memo(parse.Parser('Member Expression',
        parse.binds(
            parse.enumeration(
                parse.either(
                    newExpression,
 ...
 */
var newExpression = parse.memo(parse.Parser('New Expression',
    ecma_parse.nodea(
        parse.next(
            token.keyword('new'),
            parse.enumeration(
...
var leftHandSideExpression = (function(){
    ...
    return parse.memo(parse.Parser('Left Hand Side Expression',
        parse.binds(
            parse.enumeration(
                memberExpression,
