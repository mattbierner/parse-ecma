        ...
        parse.binda(
            ...
            function(id, parameters, body) {
                return parse.always(new astExpression.FunctionExpression(
                    id,
                    parameters,
                    new astExpression.BlockExpression(body)));
            }))));
        ...
        parse.binda(
            parse.sequence(
                ...
                parse.between(token.punctuator('{'), token.punctuator('}'),
                    functionBody)),
            function(id, params, body) {
                var block = new astExpression.BlockExpression(body);
                return parse.always(id ? 
                    new astDeclaration.FunctionDeclaration(id, params, block) :
                    new astStatement.ExpressionStatement(new astExpression.FunctionExpression(id, params, block)));
            }))));
